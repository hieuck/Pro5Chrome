...
def open_chrome(profile):
    chrome_path = chrome_var.get() or default_chrome_path  # Lấy đường dẫn Chrome từ Combobox, nếu không có thì dùng đường dẫn mặc định
...
chrome_dropdown['values'] = [default_chrome_path]
