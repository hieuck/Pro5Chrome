...
new_url_label = ttk.Label(root, text="Nhập URL mới:")
new_url_label.pack()

new_url_entry = ttk.Entry(root, width=50)
new_url_entry.pack()
...
# Nút để thêm URL mới
add_url_button = ttk.Button(root, text="Thêm URL mới", command=add_new_url)
...
open_url_button = ttk.Button(root, text="Mở URL được chọn", command=open_url_from_listbox)
open_url_button.pack(pady=10)

# Nút để xóa URL được chọn từ Listbox
delete_url_button = ttk.Button(root, text="Xóa URL được chọn", command=delete_selected_urls)
